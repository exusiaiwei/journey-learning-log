...
class SearchSpider(Spider):
    ...
    def start_requests(self):
        ...
        start_time = "2022-01-01-0"  # 格式为 年-月-日-小时, 2022-10-01-0 表示2022年10月1日0时
        end_time = "2022-02-18-00"  # 格式为 年-月-日-小时, 2022-10-07-23 表示2022年10月7日23时
        is_search_with_specific_time_scope = True  # 是否在指定的时间区间进行推文搜索
        is_sort_by_hot = False  # 是否按照热度排序,默认按照时间排序
